...
<br>
  ...
  <div class="col-md-3">
    <div class="card">
      <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/1.jpg" alt="Card image cap">
      <div class="card-body">
        <p class="card-text"><a href="inner-productpage.html" class="text-dark">Just another item name</a></p>
  ...
  <div class="col-md-3">
    <div class="card">
      <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/2.jpg" alt="Card image cap">
      <div class="card-body">
        <p class="card-text"><a href="inner-productpage.html" class="text-dark">Some item name here</a></p>
        <div class="ratings">
          <i class="fas fa-star text-warning"></i>
          <i class="fas fa-star text-warning"></i>
          <i class="fas fa-star text-warning"></i>
  ...
  <div class="col-md-3">
    <div class="card">
      <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/3.jpg" alt="Card image cap">
      <div class="card-body">
        <p class="card-text"><a href="inner-productpage.html" class="text-dark">Great item name here</a></p>
        <div class="ratings">
          <i class="fas fa-star text-warning"></i>
          <i class="fas fa-star text-warning"></i>
          <i class="fas fa-star text-warning"></i>
  ...
  <div class="col-md-3">
    <div class="card">
      <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/4.jpg" alt="Card image cap">
      <div class="card-body">
        <p class="card-text"><a href="inner-productpage.html" class="text-dark">Just another item name</a></p>
        <div class="ratings">
          <i class="fas fa-star text-warning"></i>
...
<div class="container cardItem" id="newarrive">
  ...
  <br>
    ...
    <div class="col-md-3">
      <div class="card">
        <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/5.jpg" alt="Card image cap">
        <div class="card-body">
          <p class="card-text"><a href="inner-productpage.html" class="text-dark">Just another item name</a></p>
          <div class="ratings">
            <i class="fas fa-star text-warning"></i>
    ...
    <div class="col-md-3">
      <div class="card">
        <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/6.jpg" alt="Card image cap">
        <div class="card-body">
          <p class="card-text"><a href="inner-productpage.html" class="text-dark">Some item name here</a></p>
          <div class="ratings">
            <i class="fas fa-star text-warning"></i>
    ...
    <div class="col-md-3">
      <div class="card">
        <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/7.jpg" alt="Card image cap">
        <div class="card-body">
          <p class="card-text"><a href="inner-productpage.html" class="text-dark">Great item name here</a></p>
          <div class="ratings">
            <i class="fas fa-star text-warning"></i>
    ...
    <div class="col-md-3">
      <div class="card">
        <img class="card-img-top img-fluid" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/items/9.jpg" alt="Card image cap">
        <div class="card-body">
          <p class="card-text"><a href="inner-productpage.html" class="text-dark">Just another item name</a></p>
          <div class="ratings">
            <i class="fas fa-star text-warning"></i>
  ...
  <div class="container cardItem" id="recommend">
   <div id="heading"> <h2>Recommended</h2> 
    <button type="button" class="btn btn-outline-primary" id="float">See all</button> </div>
    <br>
      <div class="row">
      <div class="col-md-3">
        <div class="card">
...
<br>
<br>
<div class="container cardItem" id="appStore">
  <h2>Download app demo text</h2> 
  <br>
  <div class="row">
    <img class="mt-3 ml-1.5" src="https://bootstrap-ecommerce.com/bootstrap-ecommerce-html/images/misc/appstore.png" alt="App Store" height="50px">
    <img class="mt-1" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Play Store" height="73px">
  </div>
</div>
<br>
  <footer>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <ul>
            ...
            <li><a href=""><i class="fab fa-twitter"></i> Content</a></li>
            <li><a href=""><i class="fab fa-instagram"></i>  Content</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <footer class="footer pt-5 pb-5" id="footer">
    <div class="container">
      <span class="text-muted float-left"><p id="copyright">&copy; 2019 Company name</p></span>
      <span class="float-right"> <p id="footerInfo"> info@pixsellz.io | +879-332-9375 | Street name 123, Avanue abc </p> </span>
    </div>
  </footer>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body bg-light">
          <form>
            ...
            <button type="submit" class="btn btn-secondary btn-sm"><a href="profile.html" class="text-light">Login</a></button>
